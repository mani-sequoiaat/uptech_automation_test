...
describe('Integration: s_agreements_error - invalid LPN/LPS check', () => {
  let client;
  ...
  test('should detect expected count of invalid records (null LPN or LPS)', async () => {
    const sql = readSQLFile('ra-management/sql/1134-s-agreements-null-lpn-lps.sql');
