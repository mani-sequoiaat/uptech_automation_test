...
describe('Integration: s_agreements_error - LPS not exactly 2 characters', () => {
  let client;
  ...
  test('should detect expected number of LPS length errors', async () => {
    const sql = readSQLFile('ra-management/sql/1138-s-agreements-lps-not-2-characters');
