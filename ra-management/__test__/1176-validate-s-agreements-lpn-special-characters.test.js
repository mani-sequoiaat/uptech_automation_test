...
describe('Integration: s_agreements_error - LPN contains special characters', () => {
  let client;
  ...
  test('should detect LPNs with special characters (error_type_id = 1176)', async () => {
    const sql = readSQLFile('ra-management/sql/1176-s-agreements-lpn-special-characters');
