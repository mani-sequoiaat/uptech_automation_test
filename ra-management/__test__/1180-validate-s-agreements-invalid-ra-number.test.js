...
describe('Integration: s_agreements_error - Invalid RA Number (error_type_id = 1180)', () => {
  let client;
  ...
  test('should detect records with invalid RA numbers in s_agreements_error', async () => {
    const sql = readSQLFile('ra-management/sql/1180-s-agreements-invalid-ra-number');
