...
describe('Integration: s_agreements_error - Invalid Checkout (error_type_id = 1182)', () => {
  let client;
  ...
  test('should detect records with invalid checkout in s_agreements_error', async () => {
    const sql = readSQLFile('ra-management/sql/1182-s-agreements-invalid-checkout');
