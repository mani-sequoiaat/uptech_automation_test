...
describe('Integration: s_agreements_error - Invalid Check-in (error_type_id = 1184)', () => {
  let client;
  ...
  test('should detect records with invalid check-in in s_agreements_error', async () => {
    const sql = readSQLFile('ra-management/sql/1184-s-agreements-invalid-checkin');
