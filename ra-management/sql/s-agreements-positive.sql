...
WHERE 
    ...
    sa.checkout_location_code IS NOT NULL OR
    sa.checkout_datetime IS NOT NULL OR
    sa.checkout_datetime <= sa.estimated_checkin_datetime OR
    sa.estimated_checkin_datetime IS NOT NULL OR
    sa.estimated_checkin_datetime > sa.checkout_datetime OR
    sa.checkin_datetime > sa.checkout_datetime OR
